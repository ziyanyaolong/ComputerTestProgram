...
LIntExport Herror T_get_texture_inspection_model_image(Hobject *ModelImages, const Htuple TextureInspectionModel);
LIntExport Herror get_texture_inspection_model_image(Hobject *ModelImages, Hlong TextureInspectionModel);
...
LIntExport Herror T_tuple_acosh(const Htuple T, Htuple *Acosh);
LIntExport Herror tuple_acosh(double T, double *Acosh);
LIntExport Herror T_tuple_asinh(const Htuple T, Htuple *Asinh);
LIntExport Herror tuple_asinh(double T, double *Asinh);
LIntExport Herror T_tuple_atanh(const Htuple T, Htuple *Atanh);
LIntExport Herror tuple_atanh(double T, double *Atanh);
LIntExport Herror T_tuple_cbrt(const Htuple T, Htuple *Cbrt);
LIntExport Herror tuple_cbrt(double T, double *Cbrt);
LIntExport Herror T_tuple_erf(const Htuple T, Htuple *Erf);
LIntExport Herror tuple_erf(double T, double *Erf);
LIntExport Herror T_tuple_erfc(const Htuple T, Htuple *Erfc);
LIntExport Herror tuple_erfc(double T, double *Erfc);
LIntExport Herror T_tuple_exp10(const Htuple T, Htuple *Exp);
LIntExport Herror tuple_exp10(double T, double *Exp);
LIntExport Herror T_tuple_exp2(const Htuple T, Htuple *Exp);
LIntExport Herror tuple_exp2(double T, double *Exp);
LIntExport Herror T_tuple_hypot(const Htuple T1, const Htuple T2, Htuple *Hypot);
LIntExport Herror tuple_hypot(double T1, double T2, double *Hypot);
LIntExport Herror T_tuple_lgamma(const Htuple T, Htuple *LogGamma);
LIntExport Herror tuple_lgamma(double T, double *LogGamma);
LIntExport Herror T_tuple_log2(const Htuple T, Htuple *Log);
LIntExport Herror tuple_log2(double T, double *Log);
LIntExport Herror T_tuple_tgamma(const Htuple T, Htuple *Gamma);
LIntExport Herror tuple_tgamma(double T, double *Gamma);
LIntExport Herror T_adapt_shape_model_high_noise(const Hobject ImageReduced, const Htuple ModelID, const Htuple GenParam, Htuple *ResultDict);
LIntExport Herror T_add_dl_pruning_batch(const Htuple DLModelHandleToPrune, const Htuple DLPruningHandle, const Htuple DLSampleBatch);
LIntExport Herror T_apply_deep_ocr(const Hobject Image, const Htuple DeepOcrHandle, const Htuple Mode, Htuple *DeepOcrResult);
LIntExport Herror T_create_deep_ocr(const Htuple GenParamName, const Htuple GenParamValue, Htuple *DeepOcrHandle);
LIntExport Herror T_create_dl_pruning(const Htuple DLModelHandle, const Htuple Mode, const Htuple GenParam, Htuple *DLPruningHandle);
LIntExport Herror T_crop_rectangle2(const Hobject Image, Hobject *ImagePart, const Htuple Row, const Htuple Column, const Htuple Phi, const Htuple Length1, const Htuple Length2, const Htuple AlignToAxis, const Htuple Interpolation);
LIntExport Herror crop_rectangle2(const Hobject Image, Hobject *ImagePart, double Row, double Column, double Phi, double Length1, double Length2, const char *AlignToAxis, const char *Interpolation);
LIntExport Herror T_gen_dl_pruned_model(const Htuple DLModelHandleToPrune, const Htuple DLPruningHandle, Htuple *DLModelHandlePruned);
LIntExport Herror T_get_deep_ocr_param(const Htuple DeepOcrHandle, const Htuple GenParamName, Htuple *GenParamValue);
LIntExport Herror T_get_dl_device_param(const Htuple DLDeviceHandle, const Htuple GenParamName, Htuple *GenParamValue);
LIntExport Herror T_get_dl_pruning_param(const Htuple DLPruningHandle, const Htuple GenParamName, Htuple *GenParamValue);
LIntExport Herror T_query_available_dl_devices(const Htuple GenParamName, const Htuple GenParamValue, Htuple *DLDeviceHandles);
LIntExport Herror T_read_deep_ocr(const Htuple FileName, Htuple *DeepOcrHandle);
LIntExport Herror T_set_deep_ocr_param(const Htuple DeepOcrHandle, const Htuple GenParamName, const Htuple GenParamValue);
LIntExport Herror T_set_dl_pruning_param(const Htuple DLPruningHandle, const Htuple GenParamName, const Htuple GenParamValue);
LIntExport Herror T_write_deep_ocr(const Htuple DeepOcrHandle, const Htuple FileName);
LIntExport Herror T_optimize_dl_model_for_inference(const Htuple DLModelHandle, const Htuple DLDeviceHandle, const Htuple Precision, const Htuple DLSamples, const Htuple GenParam, Htuple *DLModelHandleConverted, Htuple *ConversionReport);
LIntExport Herror T_set_dl_device_param(const Htuple DLDeviceHandle, const Htuple GenParamName, const Htuple GenParamValue);
