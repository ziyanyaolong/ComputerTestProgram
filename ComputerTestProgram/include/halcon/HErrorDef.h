...
#define H_ERR_TIMEOUT_BREAK 23 /* for internal use */
...
/* AI Acclerator Interface related error messages */
#define H_ERR_HAI2_ERROR                 4320 /* AI Accelerator Interface error occured */
#define H_ERR_HAI2_INVALID_PARAM         4321 /* Invalid parameter for AI Accelerator Interface */
...
#define H_ERR_INCONSISTENT_DIMENSIONS 5507 /* All channels must have equal
                                              dimensions */
...
#define H_ERR_SOCKET_NO_SERIALIZED_ITEM   5630 /* Received data is no
                                                  serialized item */
#define H_ERR_SOCKET_TLS_CONTEXT          5631 /* Unable to create SSL context */
#define H_ERR_SOCKET_TLS_CERT_KEY         5632 /* Invalid TLS certificate or private key */
#define H_ERR_SOCKET_TLS_HANDSHAKE        5633 /* Invalid TLS private key */
...
#define H_ERR_CNN_INVALID_INPUT_DATA     7736 /* CNN: Invalid input data */
#define H_ERR_CNN_CUDNN_CTC_LOSS_BUGGY   7737  /* CNN: For variable input
                                                  lengths the ctc loss layer
                                                  only computes correct
                                                  gradients if the used cuDNN
                                                  version is >= 7.6.3. Please
                                                  upgrade cuDNN or do not use
                                                  variable input lengths. */
#define H_ERR_CNN_INVALID_PADDING 7738 /* CNN: Invalid padding */
...
#define H_ERR_CNN_RUNTIME_FAILED 7742 /* CNN: Runtime not supported on this machine */
...
#define H_ERR_CNNGRAPH_AUX_SPEC       7777 /* CNN-Graph: Invalid graph
                                              ...
                                              */
#define H_ERR_CNNGRAPH_LAYER_UNSUPPORTED 7778 /* CNN-Graph: Layer not supported
                                                 for selected runtime */
...
#define H_ERR_DL_WRITE_ONNX 7803 /* Error occured while writing an ONNX model */
#define H_ERR_DL_ONNX_LOADER 7804 /* DL: Libprotobuf for ONNX could not be loaded */
...
/* DEEP OCR */
#define H_ERR_DEEP_OCR_MODEL_INTERNAL  7890 /* Deep OCR internal error */
#define H_ERR_DEEP_OCR_MODEL_INVALID_ALPHABET  7891 /* Each entry of the alphabet
                                                     can only contain a string
                                                     of length one.
                                                     */
#define H_ERR_DEEP_OCR_MODEL_INVALID_ALPHABET_IDX  7892 /* Out of bounds index
                                                         into alphabet. */
#define H_ERR_DEEP_OCR_MODEL_INVALID_MODEL_TYPE  7893 /* The type of the given DL
                                                       model is not allowed. */
#define H_ERR_DEEP_OCR_MODEL_NOT_AVAILABLE 7894 /* The model is not available. */

#define H_ERR_DEEP_OCR_MODEL_INVALID_ALPHABET_MAPPING_NO_ALPHABET  7895 /*It is
                                                                          not
                                                                          possible
                                                                          to
                                                                          specify
                                                                          ...
                                                                          specified.
                                                                          */
#define H_ERR_DEEP_OCR_MODEL_INVALID_ALPHABET_MAPPING_IDX  7896 /* Out of bounds index
                                                         into alphabet given as
                                                         mapping. */
#define H_ERR_DEEP_OCR_MODEL_INVALID_ALPHABET_MAPPING_LEN  7897 /* The length
                                                                   of the
                                                                   mapping and
                                                                   the length
                                                                   of the
...
#define H_ERR_DEEP_OCR_MODEL_FILE_NOT_FOUND 7898 /* The model file cannot be found. */
...
#define H_ERR_DL_MODEL_OPERATOR_UNSUPPORTED 7912  /* DL: Operator does not support model */
#define H_ERR_DL_MODEL_RUNTIME 7913               /* DL: Requested runtime cannot be set */
#define H_ERR_DL_MODEL_UNSUPPORTED_GENVALUE 7914  /* DL: Unsupported generic value(s) */
#define H_ERR_DL_MODEL_INVALID_NUM_SAMPLES 7915  /* DL: Invalid number of samples */
#define H_ERR_DL_MODEL_CONVERTED_PARAM 7916  /* DL: Parameter unsupported for converted model */

/* DL Device */
#define H_ERR_DL_DEVICE_UNSUPPORTED_PRECISION 7960  /* DL: Unsupported device precision */
...
/* Camera calibration */
#define H_ERR_CAL_NO_COMM_PAR     8393 /* No common camera parameters */
#define H_ERR_CAL_NEGVY     8394 /* Vy must be > 0 */
...
#define H_ERR_SM_INVLD_IMG_PAIRS_DISP_VAL  8482 /* Num of image pairs does not
                                                correspond to num of disparity values */
#define H_ERR_SM_INVLD_DISP_VAL            8483 /* Invalid min/max disparity values */
...
#define H_ERR_BC_ZOOMED_ABORTED           8730  /* The super-resolution algorithm has
                                                   been aborted */

#define H_ERR_BC_ZOOMED_INVALID_INPUT     8731  /* SRB: Invalid input data. */
...
/* Deformable matching */
#define H_ERR_DEFORM_WRONG_NUM_CLUSTER    9450 /* Invalid 'part_size' */
...
/* Edge extraction */
#define H_ERR_VIEW_ESTIM_FAIL        9499 /* Estimation of viewpose failed */
...
#define H_ERR_MINTH_TOO_SMALL            9544  /* The minimum thickness is
                                                  ...
                                                  tolerance */
#define H_ERR_OM3D_WRONG_DIMENSION       9545  /* Input width or height does
                                                  not match the number of
                                                  points in 3D object model */
#define H_ERR_OM3D_MISSING_DIMENSION     9546  /* Image width or height
                                                  must be set */
