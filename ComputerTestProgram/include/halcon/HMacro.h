...
#define HImageFD(IMAGE_OUT, VAR, KOOR)                                        \
  ...
  {                                                                           \
    double DDD = (VAR);                                                       \
    if (DDD > (double)INT2_MAX)                                               \
      DDD = INT2_MAX;                                                         \
    else if (DDD < INT2_MIN)                                                  \
      DDD = INT2_MIN;                                                         \
  ...
  {                                                                           \
    double DDD = (VAR);                                                       \
    if (DDD > (double)INT4_MAX)                                               \
      DDD = INT4_MAX;                                                         \
    else if (DDD < INT4_MIN)                                                  \
      DDD = INT4_MIN;                                                         \
  ...
  {                                                                           \
    double DDD = (VAR);                                                       \
    if (DDD > (double)HINT8_MAX)                                              \
      DDD = (double)HINT8_MAX;                                                \
    else if (DDD < HINT8_MIN)                                                 \
      DDD = HINT8_MIN;                                                        \
...
#define HIRound(Val)                                                          \
  (((Val) < 0.0) ? ((HINT)((Val)-0.5)) : ((HINT)((Val) + 0.5)))
#define HI4Round(Val)                                                         \
  (((Val) < 0.0) ? ((INT4)((Val)-0.5)) : ((INT4)((Val) + 0.5)))
#define HLRound(Val)                                                          \
  (((Val) < 0.0) ? ((INT4_8)((Val)-0.5)) : ((INT4_8)((Val) + 0.5)))
#define HI8Round(Val)                                                         \
  (((Val) < 0.0) ? ((HINT8)((Val)-0.5)) : ((HINT8)((Val) + 0.5)))
#define HIMGCOORRound(Val)                                                    \
  (((Val) < 0.0) ? ((HIMGCOOR)((Val)-0.5)) : ((HIMGCOOR)((Val) + 0.5)))
#define HFIRound(Val)                                                         \
  (((Val) < 0.0f) ? ((HINT)((Val)-0.5f)) : ((HINT)((Val) + 0.5f)))
...
#define NetToLong(N, L)                                                       \
  {                                                                           \
    unsigned char* HH;                                                        \
    HH = (unsigned char*)&(N);                                                \
    L  = ((INT4)(HH[0]) << 24) | ((INT4)(HH[1]) << 16) |                      \
        ((INT4)(HH[2]) << 8) | ((INT4)(HH[3]));                               \
  }
...
#define HNumOfChannels(PROC_HANDLE, OBJ, NUM)                                 \
  HCkP(HPNumOfChannels(PROC_HANDLE, (HINT)1, (INT4_8)OBJ, NUM))
