...
extern HLibExport Herror HRLDecomp(Hrlregion const* image_domain, HINT l1,
                                   HINT c1, HINT l2, HINT c2, Hrlregion* inner,
                                   Hrlregion* border);

extern HLibExport Herror HRCDecomp(Hvrlregion const* region, HINT l1, HINT c1,
