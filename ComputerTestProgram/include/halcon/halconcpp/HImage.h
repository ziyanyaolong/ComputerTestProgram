...
HTuple Height() const;
  ...
  HImage CropRectangle2(const HTuple& Row, const HTuple& Column, const HTuple& Phi, const HTuple& Length1, const HTuple& Length2, const HString& AlignToAxis, const HString& Interpolation) const;

  // Cut out one or more arbitrarily oriented rectangular image areas.
  HImage CropRectangle2(double Row, double Column, double Phi, double Length1, double Length2, const HString& AlignToAxis, const HString& Interpolation) const;

  // Cut out one or more arbitrarily oriented rectangular image areas.
  HImage CropRectangle2(double Row, double Column, double Phi, double Length1, double Length2, const char* AlignToAxis, const char* Interpolation) const;

#ifdef _WIN32
  // Cut out one or more arbitrarily oriented rectangular image areas.
  HImage CropRectangle2(double Row, double Column, double Phi, double Length1, double Length2, const wchar_t* AlignToAxis, const wchar_t* Interpolation) const;
#endif
