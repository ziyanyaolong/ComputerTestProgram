 ...
 *****************************************************************************/
  ...
  HTuple GetShapeModelParams(double* AngleStart, double* AngleExtent, double* AngleStep, HTuple* ScaleMin, HTuple* ScaleMax, HTuple* ScaleStep, HString* Metric, Hlong* MinContrast) const;
  ...
  HDict AdaptShapeModelHighNoise(const HImage& ImageReduced, const HTuple& GenParam) const;
