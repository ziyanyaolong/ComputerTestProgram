...
LIntExport Herror get_texture_inspection_model_image(HObject* ModelImages, const HTuple& TextureInspectionModel);
...
LIntExport Herror tuple_acosh(const HTuple& T, HTuple* Acosh);

LIntExport Herror tuple_asinh(const HTuple& T, HTuple* Asinh);

LIntExport Herror tuple_atanh(const HTuple& T, HTuple* Atanh);

LIntExport Herror tuple_cbrt(const HTuple& T, HTuple* Cbrt);

LIntExport Herror tuple_erf(const HTuple& T, HTuple* Erf);

LIntExport Herror tuple_erfc(const HTuple& T, HTuple* Erfc);

LIntExport Herror tuple_exp10(const HTuple& T, HTuple* Exp);

LIntExport Herror tuple_exp2(const HTuple& T, HTuple* Exp);

LIntExport Herror tuple_hypot(const HTuple& T1, const HTuple& T2, HTuple* Hypot);

LIntExport Herror tuple_lgamma(const HTuple& T, HTuple* LogGamma);

LIntExport Herror tuple_log2(const HTuple& T, HTuple* Log);

LIntExport Herror tuple_tgamma(const HTuple& T, HTuple* Gamma);

LIntExport Herror adapt_shape_model_high_noise(const HObject& ImageReduced, const HTuple& ModelID, const HTuple& GenParam, HTuple* ResultDict);

LIntExport Herror add_dl_pruning_batch(const HTuple& DLModelHandleToPrune, const HTuple& DLPruningHandle, const HTuple& DLSampleBatch);

LIntExport Herror apply_deep_ocr(const HObject& Image, const HTuple& DeepOcrHandle, const HTuple& Mode, HTuple* DeepOcrResult);

LIntExport Herror create_deep_ocr(const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* DeepOcrHandle);

LIntExport Herror create_dl_pruning(const HTuple& DLModelHandle, const HTuple& Mode, const HTuple& GenParam, HTuple* DLPruningHandle);

LIntExport Herror crop_rectangle2(const HObject& Image, HObject* ImagePart, const HTuple& Row, const HTuple& Column, const HTuple& Phi, const HTuple& Length1, const HTuple& Length2, const HTuple& AlignToAxis, const HTuple& Interpolation);

LIntExport Herror gen_dl_pruned_model(const HTuple& DLModelHandleToPrune, const HTuple& DLPruningHandle, HTuple* DLModelHandlePruned);

LIntExport Herror get_deep_ocr_param(const HTuple& DeepOcrHandle, const HTuple& GenParamName, HTuple* GenParamValue);

LIntExport Herror get_dl_device_param(const HTuple& DLDeviceHandle, const HTuple& GenParamName, HTuple* GenParamValue);

LIntExport Herror get_dl_pruning_param(const HTuple& DLPruningHandle, const HTuple& GenParamName, HTuple* GenParamValue);

LIntExport Herror query_available_dl_devices(const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* DLDeviceHandles);

LIntExport Herror read_deep_ocr(const HTuple& FileName, HTuple* DeepOcrHandle);

LIntExport Herror set_deep_ocr_param(const HTuple& DeepOcrHandle, const HTuple& GenParamName, const HTuple& GenParamValue);

LIntExport Herror set_dl_pruning_param(const HTuple& DLPruningHandle, const HTuple& GenParamName, const HTuple& GenParamValue);

LIntExport Herror write_deep_ocr(const HTuple& DeepOcrHandle, const HTuple& FileName);

LIntExport Herror optimize_dl_model_for_inference(const HTuple& DLModelHandle, const HTuple& DLDeviceHandle, const HTuple& Precision, const HTuple& DLSamples, const HTuple& GenParam, HTuple* DLModelHandleConverted, HTuple* ConversionReport);

LIntExport Herror set_dl_device_param(const HTuple& DLDeviceHandle, const HTuple& GenParamName, const HTuple& GenParamValue);
