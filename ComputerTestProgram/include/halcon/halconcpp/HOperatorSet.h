...
LIntExport void GetTextureInspectionModelImage(HObject* ModelImages, const HTuple& TextureInspectionModel);
...
LIntExport void TupleAcosh(const HTuple& T, HTuple* Acosh);

// Compute the inverse hyperbolic sine of a tuple.
LIntExport void TupleAsinh(const HTuple& T, HTuple* Asinh);

// Compute the inverse hyperbolic tangent of a tuple.
LIntExport void TupleAtanh(const HTuple& T, HTuple* Atanh);

// Compute the cube root of a tuple.
LIntExport void TupleCbrt(const HTuple& T, HTuple* Cbrt);

// Compute the error function of a tuple.
LIntExport void TupleErf(const HTuple& T, HTuple* Erf);

// Compute the complementary error function of a tuple.
LIntExport void TupleErfc(const HTuple& T, HTuple* Erfc);

// Compute the base 10 exponential of a tuple.
LIntExport void TupleExp10(const HTuple& T, HTuple* Exp);

// Compute the base 2 exponential of a tuple.
LIntExport void TupleExp2(const HTuple& T, HTuple* Exp);

// Calculate the hypotenuse of two tuples.
LIntExport void TupleHypot(const HTuple& T1, const HTuple& T2, HTuple* Hypot);

// Compute the logarithm of the absolute value of the gamma function of a tuple.
LIntExport void TupleLgamma(const HTuple& T, HTuple* LogGamma);

// Compute the base 2 logarithm of a tuple.
LIntExport void TupleLog2(const HTuple& T, HTuple* Log);

// Compute the gamma function of a tuple.
LIntExport void TupleTgamma(const HTuple& T, HTuple* Gamma);

// Adapt a shape model's parameters for high noise images.
LIntExport void AdaptShapeModelHighNoise(const HObject& ImageReduced, const HTuple& ModelID, const HTuple& GenParam, HTuple* ResultDict);

// Calculate scores to prune a deep learning model.
LIntExport void AddDlPruningBatch(const HTuple& DLModelHandleToPrune, const HTuple& DLPruningHandle, const HTuple& DLSampleBatch);

// Apply a Deep OCR model on a set of images for inference.
LIntExport void ApplyDeepOcr(const HObject& Image, const HTuple& DeepOcrHandle, const HTuple& Mode, HTuple* DeepOcrResult);

// Create a Deep OCR model.
LIntExport void CreateDeepOcr(const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* DeepOcrHandle);

// Create a pruning data handle.
LIntExport void CreateDlPruning(const HTuple& DLModelHandle, const HTuple& Mode, const HTuple& GenParam, HTuple* DLPruningHandle);

// Cut out one or more arbitrarily oriented rectangular image areas.
LIntExport void CropRectangle2(const HObject& Image, HObject* ImagePart, const HTuple& Row, const HTuple& Column, const HTuple& Phi, const HTuple& Length1, const HTuple& Length2, const HTuple& AlignToAxis, const HTuple& Interpolation);

// Prune a deep learning model.
LIntExport void GenDlPrunedModel(const HTuple& DLModelHandleToPrune, const HTuple& DLPruningHandle, HTuple* DLModelHandlePruned);

// Return the parameters of a Deep OCR model.
LIntExport void GetDeepOcrParam(const HTuple& DeepOcrHandle, const HTuple& GenParamName, HTuple* GenParamValue);

// Return the parameters of a deep-learning-capable hardware device.
LIntExport void GetDlDeviceParam(const HTuple& DLDeviceHandle, const HTuple& GenParamName, HTuple* GenParamValue);

// Get information from a pruning data handle.
LIntExport void GetDlPruningParam(const HTuple& DLPruningHandle, const HTuple& GenParamName, HTuple* GenParamValue);

// Get list of deep-learning-capable hardware devices.
LIntExport void QueryAvailableDlDevices(const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* DLDeviceHandles);

// Read a Deep OCR model from a file.
LIntExport void ReadDeepOcr(const HTuple& FileName, HTuple* DeepOcrHandle);

// Set the parameters of a Deep OCR model.
LIntExport void SetDeepOcrParam(const HTuple& DeepOcrHandle, const HTuple& GenParamName, const HTuple& GenParamValue);

// Set parameter in a pruning data handle.
LIntExport void SetDlPruningParam(const HTuple& DLPruningHandle, const HTuple& GenParamName, const HTuple& GenParamValue);

// Write a Deep OCR model in a file.
LIntExport void WriteDeepOcr(const HTuple& DeepOcrHandle, const HTuple& FileName);

// Optimize a model for inference on a device via the AI2-interface.
LIntExport void OptimizeDlModelForInference(const HTuple& DLModelHandle, const HTuple& DLDeviceHandle, const HTuple& Precision, const HTuple& DLSamples, const HTuple& GenParam, HTuple* DLModelHandleConverted, HTuple* ConversionReport);

// Set the parameters of a deep-learning-capable hardware device.
LIntExport void SetDlDeviceParam(const HTuple& DLDeviceHandle, const HTuple& GenParamName, const HTuple& GenParamValue);
